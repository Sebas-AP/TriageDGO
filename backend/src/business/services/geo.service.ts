...
/**
 * Geo service implementation using local school catalog and Open-Meteo API.
 *
 * - `schoolNear`: finds schools within 500m using Haversine distance
 * - `weatherAggravates`: checks Open-Meteo for precipitation (drenaje reports only)
 */
